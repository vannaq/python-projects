...
#Filter dataframe for Movies only
movies_only = netflix_df[netflix_df["type"] == "Movie"]


#Filter dataframe for Movies released between 1990 to 1999
movies_1990s = netflix_df[(netflix_df["release_year"] >= 1990) & (netflix_df["release_year"] < 2000)]

#View single column of dataframe, also known as a series, in histogram
...
#Filter for short action movies genre, which is less than 90 minutes long
...
short_movies_count = len(short_action_movies)
print(f"The number of short action movies released in 1990s is {short_movies_count}.")
