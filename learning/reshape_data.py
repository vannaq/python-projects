...
#example melting: df.melt(id_vars=['column1','column2']) where columns are to be used as identifier variables. Note that even if there's only 1 column value in id_vars, use the square brackets
